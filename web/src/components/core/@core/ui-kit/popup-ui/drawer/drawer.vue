...
import {
  ...
  usePriorityValues,
  useSimpleLocale,
} from '#/components/core/effects/hooks';
...
import {ELEMENT_ID_MAIN_CONTENT} from '#/components/core/constants';
import {globalShareState, cn} from '#/components/core/utils';
        ...
        <div class="flex items-center">
          ...
          <SheetTitle v-if="title" class="text-left">
            <slot name="title">
              ...
              <BasicHelpTooltip v-if="titleTooltip" trigger-class="pb-1">
                {{ titleTooltip }}
              </BasicHelpTooltip>
            </slot>
          </SheetTitle>
