...
import type { BasicButtonProps } from '#/components/core/@core/ui-kit/shadcn-ui';
import type { ClassType, MaybeComputedRef } from '#/components/core/@core/typings';

import type { FormApi } from './form-api';
import { BasicFormProps } from '#/components/core/effects/common-ui';
...
export interface ActionButtonOptions extends BasicButtonProps {
  [key: string]: any;
...
export type ExtendedFormApi = FormApi & {
  useStore: <T = NoInfer<BasicFormProps>>(
    selector?: (state: NoInfer<BasicFormProps>) => T,
  ) => Readonly<Ref<T>>;
};

export interface BasicFormAdapterOptions<
  T extends BaseFormComponentType = BaseFormComponentType,
> {
  config?: {
