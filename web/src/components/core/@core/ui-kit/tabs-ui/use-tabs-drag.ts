import type { Sortable } from '#/components/core/effects/hooks';
import type { EmitType } from '#/components/core/@core/typings';

import type { TabsProps } from './types';

import { nextTick, onMounted, onUnmounted, ref, watch } from 'vue';

import { useIsMobile, useSortable } from '#/components/core/effects/hooks';
