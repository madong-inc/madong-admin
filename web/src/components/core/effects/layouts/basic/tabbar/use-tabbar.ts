...
import type { TabDefinition } from '#/components/core/@core/typings';

import type { IContextMenuItem } from '#/components/core/@core/ui-kit/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '#/components/core/effects/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { useAccessStore, useTabbarStore } from '#/components/core/stores';
import { filterTree } from '#/components/core/utils';
