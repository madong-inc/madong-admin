...
import type { NormalMenuProps } from '#/components/core/@core/ui-kit/menu-ui';

import { onBeforeMount } from 'vue';
import { useRoute } from 'vue-router';

import { findMenuByPath } from '#/components/core/utils';

import { NormalMenu } from '#/components/core/@core/ui-kit/menu-ui';
