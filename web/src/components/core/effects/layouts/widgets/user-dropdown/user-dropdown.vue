...
import type { AnyFunction } from '#/components/core/@core/typings';

import { computed, useTemplateRef, watch } from 'vue';

import { useHoverToggle } from '#/components/core/effects/hooks';
import { LockKeyhole, LogOut } from '#/components/core/icons';
import { $t } from '#/locale';
import { preferences, usePreferences } from '#/components/core/@core/preferences';
import { useLockStore } from '#/components/core/stores';
import { isWindowsOs } from '#/components/core/utils';

import { useModal } from '#/components/core/@core/ui-kit/popup-ui';
import {
  Badge,
  DropdownMenu,
  DropdownMenuContent,
    ...
    <DropdownMenuTrigger ref="refTrigger" :disabled="props.trigger === 'hover'">
      <div class="hover:bg-accent ml-1 mr-2 cursor-pointer rounded-full p-1.5">
        <div class="hover:text-accent-foreground flex-center">
          <BasicAvatar :alt="text" :src="avatar" class="size-8" dot />
        </div>
      </div>
    </DropdownMenuTrigger>
    <DropdownMenuContent class="mr-2 min-w-[240px] p-0 pb-1">
      <div ref="refContent">
        ...
        <DropdownMenuItem
          ...
          @click="menu.handler"
        >
          <BasicIcon :icon="menu.icon" class="mr-2 size-4" />
          {{ menu.text }}
        </DropdownMenuItem>
        <DropdownMenuSeparator />
        <DropdownMenuItem
