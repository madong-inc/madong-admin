...
import type { BuiltinThemePreset } from '#/components/core/@core/preferences';
import type { BuiltinThemeType } from '#/components/core/@core/typings';

import { computed, ref, watch } from 'vue';

import { UserRoundPen } from '#/components/core/icons';
import { $t } from '#/locale';
import { BUILT_IN_THEME_PRESETS } from '#/components/core/@core/preferences';
import { convertToHsl, TinyColor } from '#/components/core/utils';
