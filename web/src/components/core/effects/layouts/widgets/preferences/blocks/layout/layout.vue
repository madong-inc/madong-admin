...
import type { LayoutType } from '#/components/core/@core/typings';
...
import { BasicTooltip } from '#/components/core/@core/ui-kit/shadcn-ui';
  ...
  <div class="flex w-full flex-wrap gap-5">
    <template v-for="theme in PRESET" :key="theme.name">
      ...
      >
        ...
        >
          {{ theme.name }}
          <BasicTooltip v-if="theme.tip" side="bottom">
            <template #trigger>
