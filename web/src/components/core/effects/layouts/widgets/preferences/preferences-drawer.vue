...
import type {
  ...
  ThemeModeType,
} from '#/components/core/@core/typings';

import type { SegmentedItem } from '#/components/core/@core/ui-kit/shadcn-ui';

import { computed, ref } from 'vue';

import { Copy, RotateCw } from '#/components/core/icons';
...
import { useDrawer } from '#/components/core/@core/ui-kit/popup-ui';
import {
  BasicButton,
  BasicIconButton,
  BasicSegmented,
} from '#/components/core/@core/ui-kit/shadcn-ui';
import { globalShareState } from '#/components/core/utils';
...
<template>
  <div>
    ...
    >
      ...
      <div class="p-1">
        <BasicSegmented v-model="activeTab" :tabs="tabs">
          <template #general>
