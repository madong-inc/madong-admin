...
import { ArrowLeft, RotateCw } from '#/components/core/icons';
...
<template>
  <div class="flex size-full flex-col items-center justify-center duration-300">
    ...
    <div class="flex-col-center">
      ...
      <BasicButton v-else-if="showBack" size="lg" @click="back">
        <ArrowLeft class="mr-2 size-4" />
        {{ $t('common.backToHome') }}
      </BasicButton>
      <BasicButton v-else-if="showRefresh" size="lg" @click="refresh">
