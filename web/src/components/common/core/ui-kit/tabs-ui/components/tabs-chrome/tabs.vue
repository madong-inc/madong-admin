...
import { Pin, X } from '#/components/common/icons';
import { BasicContextMenu, BasicIcon } from '#/components/common/core/ui-kit/shadcn-ui';
...
const props = withDefaults(defineProps<Props>(), {
  contentClass: 'madong-tabs-content',
  contextMenus: () => [],
  gap: 7,
  tabs: () => [],
});
