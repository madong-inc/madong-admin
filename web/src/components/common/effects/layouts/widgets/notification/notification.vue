...
import { Bell, MailCheck } from '#/components/common/icons';
  ...
  >
    <template #trigger>
      <div class="flex-center mr-2 h-full" @click.stop="toggle()">
        <BasicIconButton class="bell-button text-foreground relative">
          <span
            v-if="dot"
    ...
    <div class="relative">
      ...
      <BasicScrollbar v-if="notifications.length > 0">
      ...
      >
        ...
        <BasicButton size="sm" @click="handleViewAll">
