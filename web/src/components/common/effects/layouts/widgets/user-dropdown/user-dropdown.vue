...
import type { AnyFunction } from '#/components/common/core/typings';

import { computed, useTemplateRef, watch } from 'vue';

import { useHoverToggle } from '#/components/common/effects/hooks';
import { LockKeyhole, LogOut } from '#/components/common/icons';
...
import { isWindowsOs } from '#/components/common/utils';
