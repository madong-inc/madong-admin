...
import type { BuiltinThemePreset } from '#/components/common/core/preferences';
import type { BuiltinThemeType } from '#/components/common/core/typings';

import { computed, ref, watch } from 'vue';

import { UserRoundPen } from '#/components/common/icons';
import { $t } from '#/locale';
import { BUILT_IN_THEME_PRESETS } from '#/components/common/core/preferences';
import { convertToHsl, TinyColor } from '#/components/common/utils';
