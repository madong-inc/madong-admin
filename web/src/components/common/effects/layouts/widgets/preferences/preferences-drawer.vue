...
import type {
  ...
  ThemeModeType,
} from '#/components/common/core/typings';

import type { SegmentedItem } from '#/components/common/core/ui-kit/shadcn-ui';

import { computed, ref } from 'vue';

import { Copy, RotateCw } from '#/components/common/icons';
