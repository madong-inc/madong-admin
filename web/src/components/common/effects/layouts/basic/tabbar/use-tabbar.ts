...
import type { TabDefinition } from '#/components/common/core/typings';

import type { IContextMenuItem } from '#/components/common/core/ui-kit/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '#/components/common/effects/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { useAccessStore, useTabbarStore } from '#/components/common/stores';
import { filterTree } from '#/components/common/utils';
