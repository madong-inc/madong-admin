...
import { BasicLoading, BasicSpinner } from '#/components/common/core/ui-kit/shadcn-ui';
import { isString } from '#/components/common/utils';
...
const loadingDirective: Directive = {
  mounted(el, binding) {
    const instance = h(BasicLoading, getOptions(binding));
    render(instance, el);
...
const spinningDirective: Directive = {
  mounted(el, binding) {
    const instance = h(BasicSpinner, getOptions(binding));
    render(instance, el);
