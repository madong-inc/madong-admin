...
import { SystemCrontabLogApi, SystemCrontabLogRow } from "#/api/monitor/crontab";
    ...
    <Grid>
      <template #toolbar-buttons>
        <TableAction
          :actions="[
            {
              label: $t('system.crontab_log.list.table.toolbar.delete.label'),
              type: 'primary',
              icon: 'ant-design:delete-outlined',
              show: hasTopTableDropDownActions,
              danger: true,
              auth: ['admin', 'monitor:crontab_log:delete'],
      ...
      <template #ACTION="{ row }">
        <TableAction
          :actions="[
            {
              label: $t('system.crontab_log.list.table.columns.actions.delete.label'),
              danger: true,
              icon: 'ant-design:delete-outlined',
              auth: ['admin', 'system:crontab_log:delete'],
              popConfirm: {
                title:  $t('system.crontab_log.list.table.columns.actions.delete.confirm'),
