...
const options = [
  { label: $t('system.dict_item.form.tag_style.default'), value: 'default' },
  { label: $t('system.dict_item.form.tag_style.custom'), value: 'custom' },
];

console.log($t('system.dict_item.message.success'))
/**
 * 主要是加了const报错
 */
...
<template>
  <div class="flex flex-1 items-center gap-[6px]">
    ...
    <Select
      ...
      class="flex-1"
      :placeholder="$t('system.dict_item.form.tag_style.default')"
