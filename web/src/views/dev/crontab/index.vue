...
import { SystemCrontabApi } from "#/api/dev/crontab";
import type { SystemCrontabRow } from "#/api/dev/crontab";
    ...
    <Grid>
      <template #toolbar-buttons>
        <TableAction
          :actions="[
            {
              label: $t('dev.crontab.list.table.toolbar.create'),
              type: 'primary',
              icon: 'ant-design:plus-outlined',
              auth: ['admin', 'dev:crontab:create'],
