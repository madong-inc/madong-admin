 ...
 * @since  1.0
 */
class RateRestrictionsController extends Crud
{

    public function __construct()
    {
        parent::__construct();//调用父类构造函数
        $this->service  = Container::make(SysRetaRestrictionsService::class);
        $this->validate = Container::make(RateRestrictionsValidate::class);
    }
    ...
    public function store(Request $request): \support\Response
    {
        try {
            ...
            $pk = $model->getPk();
            //添加后移除缓存
            $this->service->cacheDriver()->delete(SysRetaRestrictionsService::CACHE_KEY);
