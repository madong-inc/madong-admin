 ...
 * 负责生成 DTO 文件内容
 */
class RequestFormGenerator implements FileGeneratorInterface
{
    /**
     * @var array 配置信息
     */
    ...
    public function generateContent(): string
    {
        ...
        if ($isPlugin) {
            // 插件模式：plugin\{plugin_name}\app\schema\request\{package_name}
            $namespace = "plugin\\{$pluginName}\\app\\schema\\request\\{$packageName}";
        } else {
            // App 模式：app\adminapi\schema\\request\{package_name}
        ...
        return $this->templateRenderer->render('server/schema/request/form.stub', $data);
    }
