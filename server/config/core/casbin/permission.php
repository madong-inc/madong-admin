...
return [
    ...
    'basic'   => [
        ...
        'model'    => [
            'config_type'      => 'file',
            'config_file_path' => config_path() . '/core/casbin/rbac-model.conf',
            'config_text'      => '',
        ],
        // 适配器
        'adapter'  => core\casbin\adapter\DatabaseAdapter::class,
        // 数据库设置
        'database' => [
            'connection'  => '',
    ...
    'restful' => [
        'model'    => [
            'config_type'      => 'file',
            'config_file_path' => config_path() . '/core/casbin/restful-model.conf',
            'config_text'      => '',
        ],
        'adapter'  => core\casbin\adapter\DatabaseAdapter::class,//适配器
        'database' => [
            'connection'  => '',
