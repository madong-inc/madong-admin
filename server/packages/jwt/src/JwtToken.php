...
use madong\jwt\exception\JwtCacheTokenException;
use madong\jwt\exception\JwtRefreshTokenExpiredException;
use madong\jwt\exception\JwtTokenException;
use madong\jwt\exception\JwtConfigException;
use madong\jwt\exception\JwtTokenExpiredException;
use Throwable;
...
class JwtToken
{
    ...
    {
        $authorization = request()->header(config('plugin.madong.jwt.app.jwt.token_name','Authorization'));
        if (!$authorization) {
    ...
    {
        $config = config('plugin.madong.jwt.app.jwt');
        if (empty($config)) {
     ...
     *
     * @return \madong\jwt\exception\JwtTokenException|\madong\jwt\exception\JwtTokenExpiredException|\madong\jwt\exception\JwtRefreshTokenExpiredException
     */
