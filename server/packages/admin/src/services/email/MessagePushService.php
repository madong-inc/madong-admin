...
namespace madong\admin\services\email;
...
class MessagePushService
{
    ...
    {
        self::initApi();
        $noticeServer = new SysNoticeService();
     ...
     * @param \app\common\model\system\SysMessage|null $model
     */
     ...
     * 广播消息到所有用户
     *
     * @param \app\common\model\system\SysNotice $model
     */
    public static function modelNotice(SysNotice $model): void
    {
        self::initApi();
        $data = [
     ...
     * 消息推送
     *
     * @param \app\common\model\system\SysMessage $model
     * @param string                              $id
     */
    public static function modelMessage(SysMessage $model, string $id): void
    {
        self::initApi();
        $data = [
            'id'           => (string)$model->getAttribute('id'),
