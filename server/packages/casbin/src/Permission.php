...
use madong\casbin\watcher\RedisWatcher;
use madong\casbin\traits\PermissionTrait;
...
class Permission
{
    ...
    {
        if (!is_null($name)) {
            return config('plugin.madong.casbin.permission.' . $name, $default);
        }
        return config('plugin.madong.casbin.permission.default');
    }
