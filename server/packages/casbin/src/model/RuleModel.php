...
//        $this->setTable($this->config('database.rules_table'));
    ...
    {
        $driver = $this->driver ?? config('plugin.madong.casbin.permission.default');
        return config('plugin.madong.casbin.permission.' . $driver . '.' . $key, $default);
    }
