/*
 ...
 Source Schema         : madong_v3

 Target Server Type    : MySQL
 Target Server Version : 80012
 File Encoding         : 65001

 Date: 02/06/2025 22:12:51
*/
...
CREATE TABLE `ma_system_dept`  (
  ...
  `tenant_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '000000' COMMENT '租户编号',
...
CREATE TABLE `ma_system_dict`  (
  ...
  `enabled` smallint(6) NULL DEFAULT 1 COMMENT '状态 (1正常 0停用)',
  `created_by` bigint(11) NULL DEFAULT NULL COMMENT '创建者',
  `updated_by` bigint(11) NULL DEFAULT NULL COMMENT '更新者',
  `created_at` bigint(11) NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` bigint(11) NULL DEFAULT NULL COMMENT '修改时间',
  `deleted_at` bigint(11) NULL DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ma_system_login_log`  (
  ...
  `created_at` bigint(11) NULL DEFAULT NULL COMMENT '创建时间',
  `expires_at` bigint(11) NULL DEFAULT NULL COMMENT '过期时间',
  `updated_at` bigint(11) NULL DEFAULT NULL COMMENT '更新时间',
  `deleted_at` bigint(11) NULL DEFAULT NULL COMMENT '删除时间',
...
-- ----------------------------
-- Table structure for ma_system_message
-- ----------------------------
DROP TABLE IF EXISTS `ma_system_message`;
CREATE TABLE `ma_system_message`  (
...
-- ----------------------------
-- Table structure for ma_system_notice
-- ----------------------------
DROP TABLE IF EXISTS `ma_system_notice`;
CREATE TABLE `ma_system_notice`  (
  ...
  `sort` int(10) NULL DEFAULT 10 COMMENT '排序',
...
-- ----------------------------
-- Table structure for ma_system_role_scope_dept
-- ----------------------------
DROP TABLE IF EXISTS `ma_system_role_scope_dept`;
CREATE TABLE `ma_system_role_scope_dept`  (
  `role_id` bigint(20) UNSIGNED NOT NULL COMMENT '用户主键',
  `dept_id` bigint(20) UNSIGNED NOT NULL COMMENT '角色主键'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '角色与部门关联表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for ma_system_route
-- ----------------------------
DROP TABLE IF EXISTS `ma_system_route`;
CREATE TABLE `ma_system_route`  (
...
-- ----------------------------
-- Table structure for ma_system_route_cate
-- ----------------------------
DROP TABLE IF EXISTS `ma_system_route_cate`;
CREATE TABLE `ma_system_route_cate`  (
  `id` bigint(20) NOT NULL,
  `tenant_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '000000' COMMENT '租户编号',
...
-- ----------------------------
-- Table structure for ma_system_tenant
-- ----------------------------
DROP TABLE IF EXISTS `ma_system_tenant`;
CREATE TABLE `ma_system_tenant`  (
  `id` bigint(20) NOT NULL COMMENT 'id',
  `tenant_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '000000' COMMENT '租户编号',
  `package_id` bigint(20) NULL DEFAULT NULL COMMENT '关联套餐',
  ...
  `enabled` tinyint(4) NULL DEFAULT 0 COMMENT '启用状态',
  `deleted_at` bigint(20) NULL DEFAULT NULL COMMENT '是否删除',
  `created_dept` bigint(20) NULL DEFAULT NULL COMMENT '创建部门',
  `created_by` bigint(20) NULL DEFAULT NULL COMMENT '创建者',
  `created_at` bigint(11) NULL DEFAULT NULL COMMENT '创建时间',
...
-- ----------------------------
-- Table structure for ma_system_tenant_package
-- ----------------------------
DROP TABLE IF EXISTS `ma_system_tenant_package`;
CREATE TABLE `ma_system_tenant_package`  (
  `id` bigint(20) NOT NULL COMMENT 'id',
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '套餐名称',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
  `enabled` tinyint(4) NULL DEFAULT 1 COMMENT '状态（0正常 1停用）',
  `created_dept` bigint(20) NULL DEFAULT NULL COMMENT '创建部门',
  `created_by` bigint(20) NULL DEFAULT NULL COMMENT '创建者',
  `created_at` bigint(20) NULL DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint(20) NULL DEFAULT NULL COMMENT '更新者',
  `updated_at` bigint(20) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '租户套餐订阅表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for ma_system_tenant_package_menu
-- ----------------------------
DROP TABLE IF EXISTS `ma_system_tenant_package_menu`;
CREATE TABLE `ma_system_tenant_package_menu`  (
  `package_id` bigint(20) UNSIGNED NOT NULL COMMENT '套餐主键',
  `menu_id` bigint(20) UNSIGNED NOT NULL COMMENT '菜单主键'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '租户套餐与菜单关联表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `ma_system_user`  (
  ...
  `is_super` tinyint(4) NULL DEFAULT 2 COMMENT '用户类型:(1顶级管理员 2普通用户 3租户管理员)',
  ...
  `updated_by` bigint(20) NULL DEFAULT NULL COMMENT '更新者',
  `created_at` bigint(11) NULL DEFAULT NULL COMMENT '创建时间',
  `updated_at` bigint(10) UNSIGNED NULL DEFAULT NULL COMMENT '修改时间',
